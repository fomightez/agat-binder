...
Click a 'launch binder' badge below to start a Jupyter session where AGAT is already installed and running right in your browser on a temporary remote session. No need to login or intall anything.

[![Binder](https://mybinder.org/badge_logo.svg)](https://mybinder.org/v2/gh/fomightez/agat-binder/HEAD?urlpath=%2Flab%2Ftree%2Fdemo.ipynb) 
...
[AGAT's GitHub repository](https://github.com/NBISweden/AGAT)  
[AGAT Documentation is here](https://nbisweden.github.io/AGAT/) 

Description Summary from [Anaconda's package overview](https://anaconda.org/channels/bioconda/packages/agat/overview):
...
JupyterLab interface: [![Binder](https://mybinder.org/badge_logo.svg)](https://mybinder.org/v2/gh/fomightez/agat-binder/HEAD?urlpath=%2Flab%2Ftree%2Fdemo.ipynb)  
Jupyter Notebook 7+:  [![Binder](https://mybinder.org/badge_logo.svg)](https://mybinder.org/v2/gh/fomightez/agat-binder/HEAD?urlpath=%2Ftree%2Fdemo.ipynb)
